      ...
      {jsonFile.map((planets) => {
        if (planets["name"] == name) {
          return (
            ...
            {/* Main  */}
            <div className="main" style={{display: hamburger? 'block': 'none' }}>
              {/* Main Header  */}
               {overview? (
                <div className="content">
                  ...
                  {/* Image  */}
                  <div className="image">
                    <img src={planets.images.internal} alt={planets.name} />
                  </div>
                  ...
                  <div className="image-surface">
                    <img className='surface-one' src={planets.images.planet} alt={planets.name} />
                    <img className='surface-two' src={planets.images.geology} alt={planets.name} />
                  </div>
