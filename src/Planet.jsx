...
const MainDiv = styled.div(
  (props) => css`
    @media (min-width: 375px) {
      ...
      height: max-content;
      padding: 0 24px;
      display: ${props.hamburger ? "flex" : "none"};
...
const FilterDiv = styled.div(
  (props) => css`
    @media (min-width: 768px) {
      ...
      align-items: center;
      padding: 8px 20px;
      background-color: ${props.filter ? props.color : "#070724"};
    }
    ...
    @media (min-width: 1440px) {
      ...
      background-color: ${props.filter ? props.color : "#070724"};
      &:hover {
        background-color: ${!props.filter ? "rgb(216, 216, 216, 0.2)" : null};
        cursor: pointer;
      }
    }
  `
